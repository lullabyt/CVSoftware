...
export class TipoPiezaInspeccionadaService {
  ...
  private asignacionUrl = VariablesGlobales.BASE_API_URL + '/movimiento/tipoPiezaInspeccionada/registrarAsignacion';
  private instrumentosUrl = VariablesGlobales.BASE_API_URL + '/movimiento/tipoPiezaInspeccionada/obtenerInstrumentosTipoTrabajo';
  private ordenesUrl = VariablesGlobales.BASE_API_URL + '/movimiento/tipoPiezaInspeccionada/obtenerOrdenes';
  private personalUrl = VariablesGlobales.BASE_API_URL + '/movimiento/tipoPiezaInspeccionada/obtenerPersonal';
  private trabajosUrl = VariablesGlobales.BASE_API_URL + '/movimiento/tipoPiezaInspeccionada/obtenerTrabajosOrden';
